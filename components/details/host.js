...
async function getHostDetails(commandInfo) {
    ...
    // print for debug
    pretty.print(`Host details requested for server type ${serverType}.`);
    pretty.print(`Host details: ${xIPAddress}:${xPort} and ${bIPAddress}:${bPort}.`);
    pretty.print(`Sending host details to client.`);
